...
def calculate_ssim(prediction, target):
    ...
    sigma_pred_sq = torch.nn.functional.avg_pool2d(prediction ** 2, kernel_size=11, stride=1, padding=5) - mu_pred_sq
    sigma_target_sq = torch.nn.functional.avg_pool2d(target ** 2, kernel_size=11, stride=1, padding=5) - mu_target_sq
    sigma_cross = torch.nn.functional.avg_pool2d(prediction * target, kernel_size=11, stride=1, padding=5) - mu_cross
