...
def save_comparison(hazy_batch, predicted_batch, clean_batch, save_path, num_images=4):
...
def plot_training_curves(train_losses, val_losses, train_psnrs=None, val_psnrs=None, save_path=None):
    fig, axes = plt.subplots(1, 2 if train_psnrs else 1, figsize=(14 if train_psnrs else 7, 5))
    if train_psnrs:
        ax1, ax2 = axes
    else:
        ax1 = axes
