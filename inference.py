...
def main():
    ...
    parser.add_argument('--image', type=str, required=True,
                        help='Hazy image ka path')
    parser.add_argument('--output', type=str, default='dehazed_output.jpg',
                        help='Output image kahan save karo')
    parser.add_argument('--checkpoint', type=str, default='experiments/best_model.pth',
                        help='Model checkpoint ka path')
    ...
    dehaze_image(model, args.image, args.output,
                 image_size=config['data']['image_size'], device=device)
